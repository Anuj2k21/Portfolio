         ...
         <ImageEvent date="March/2021" className="text-center" text="Indiamart cloned website" src={mart} alt="Chat Room">
            <div className="d-flex justify-content-between flex-column mt-1">
                ...
                <Accordion>
                  <Card>
                    ...
                    <Accordion.Collapse eventKey="0" className="text-left">
                      <Card.Body>
                        <strong>Description:</strong> AMAZON PRIME VIDEO CLONE.
                        <hr />
              ...
              <div className="d-flex justify-content-between flex-nowrap text-center">
                <UrlButton href="https://admirable-dusk-611410.netlify.app/" target="_blank">
                  SEE LIVE
                </UrlButton>
                { <UrlButton href="https://github.com/Deep1897/PRIME-VIDEO.git" target="_blank">
                  SOURCE CODE
                </UrlButton> }
        ...
        {/* Project: Smart Brain */}
          <ImageEvent date="April/2022" className="text-center" text="A Website Named Mamaearth" src={mamearth} alt="Smart Brain Face Detect">
            <div className="d-flex justify-content-between flex-column mt-1">
              ...
              <div className="d-flex justify-content-between flex-nowrap text-center">
                <UrlButton href="https://enchanting-malabi-c45a77.netlify.app/" target="_blank">
                  SEE LIVE
                </UrlButton>
                <UrlButton href="https://github.com/mdnasirdmt/kimaye_project.git" target="_blank">
                  SOURCE CODE
                </UrlButton>
              </div>
            </div>
